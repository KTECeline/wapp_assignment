    ...
    return (
        <VisitorLayout>
            ...
            <div className="mt-[36px] items-center text-black flex flex-col w-full">
                ...
                {/* Visitor-specific message prompting registration */}
                <div className="mt-[32px] flex justify-center items-center w-full">
                    <div className="text-center bg-white p-8 rounded-lg shadow-md">
                        <div className="font-ibarra text-[18px] font-bold">
                            Register/Log In to unlock My Collections!
                        </div>
                        <div className="mt-4 flex justify-center gap-4">
                            <NavLink to="/Login" className="px-4 py-2 border rounded-full text-sm hover:bg-[#f3f3f3]">Log In</NavLink>
                            <NavLink to="/Register" className="px-4 py-2 border rounded-full text-sm hover:bg-[#f3f3f3]">Register</NavLink>
                        </div>
                    </div>
                </div>
            ...
            <div className="mt-[62px] items-center text-black flex flex-col w-full bg-[#F8F5F0] pt-[36px] pb-[62px]">
                ...
                <div className="mt-[32px] flex flex-row gap-[14px] max-w-screen">
                    ...
                    {/* The rest of this layout mirrors the registered user home for consistency */}
