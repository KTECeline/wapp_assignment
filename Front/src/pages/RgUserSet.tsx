                ...
                <div className="w-[554px] pb-[64px]">
                    ...
                    {active === "Get Help" && (
                        <div className="flex flex-col h-[600px]">
                            <p className="font-ibarra font-bold text-black text-[36px] mb-4">
                            ...
                            <div className="flex-1 bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex flex-col">
                                {selectedSession ? (
                                    <>
                                        ...
                                        <div className="pb-4 border-b border-gray-200 mb-4 flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="w-12 h-12 rounded-full bg-[#DA1A32] flex items-center justify-center text-white font-semibold">
                                                    A
                                                </div>
                                                <div>
                                                    <h3 className="font-bold text-gray-900">Admin Support</h3>
                                                    <p className="text-sm text-gray-500">{selectedSession.status === 'active' ? 'Online' : 'Session Closed'}</p>
                                                </div>
                                            </div>
                                            <button
                                                onClick={() => setSelectedSession(null)}
                                                className="px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg hover:bg-gray-100 transition-colors"
                                            >
                                                Back to Sessions
                                            </button>
                                        </div>
                                        ...
                                        <div className="flex-1 overflow-y-auto pr-2 mb-4 space-y-3">
                                            {selectedSession.messages?.map((message: any) => (
                                                <div
                                                    key={message.id}
                                                    className={`flex ${message.sentByAdmin ? 'justify-start' : 'justify-end'}`}
                                                >
                                                    <div
                                                        className={`max-w-[70%] p-3 rounded-2xl ${
                                                            message.sentByAdmin
                                                                ? 'bg-[#F8F5F0] text-gray-900 rounded-bl-sm'
                                                                : 'bg-[#DA1A32] text-white rounded-br-sm'
                                                        }`}
                                                    >
                                                        <p className="text-sm leading-relaxed">{message.content}</p>
                                                        <p className={`text-xs mt-1 ${message.sentByAdmin ? 'text-gray-500' : 'text-white/70'}`}>
                                        ...
                                        {selectedSession.status === 'active' ? (
                                            <form onSubmit={(e) => { e.preventDefault(); handleSendFollowup(); }} className="flex gap-2">
                                                <input
                                                    type="text"
                                                    value={messageInput}
                                                    onChange={(e) => setMessageInput(e.target.value)}
                                                    placeholder="Type your message..."
                                                    className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#DA1A32] focus:border-transparent outline-none text-sm"
                                                />
                                                <button
                                                    type="submit"
                                                    className="px-6 py-3 bg-[#DA1A32] hover:bg-[#b8152a] text-white rounded-xl font-medium transition-all flex items-center gap-2 shadow-sm"
                                                >
                                            ...
                                            <div className="text-center py-4 text-gray-500 text-sm border border-gray-200 rounded-xl">
                                    ...
                                    <>
                                        {/* No session selected - show input to start new session */}
                                        <div className="flex-1 flex flex-col">
                                            ...
                                            {sessions.length > 0 && (
                                                <>
                                                    <p className="font-ibarra font-bold text-black text-[20px] mb-3">
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex items-center gap-2 mt-1">
                                                                    <p className="text-[12px] text-gray-500">
                                                                        {new Date(s.firstMessageTime).toLocaleString('en-US', {
                                                                            month: 'short',
                                                                            day: 'numeric',
                                                                            hour: 'numeric',
                                                                            minute: '2-digit',
